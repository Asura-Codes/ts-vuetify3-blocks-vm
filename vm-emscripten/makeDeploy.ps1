...
emcc -O3 -lembind dist/vm.o dist/vm-ops.o dist/jsprintf.o dist/main.o -sEXPORTED_RUNTIME_METHODS="cwrap,ccall" -sEXPORT_ES6=1 -sMODULARIZE=1 -sUSE_ES6_IMPORT_META=1 -sERROR_ON_UNDEFINED_SYMBOLS=0 -sALLOW_MEMORY_GROWTH=1 -o dist/vm.html  # DEPLOY